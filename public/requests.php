    ...
    <div class="request-content">
      ...
      <div class="request-content-container">
        <div class="content-container-list">
          <div v-for="card in cards" class="list-item">
            <img class="list-item_img" :src="card.img" alt="dog">
            <div class="item_title">{{card.title}}</div>
            <div class="item_title item-about_text">{{card.servise}}</div>
            <div class="item_title item-about_text">{{card.status}}</div>
          </div>
        </div>
        <div id="form" class="request-form">
